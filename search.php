...
$usernameResult = $access->findMatchUsername($search, $id);
$result = $access->findMatchResult($search);


if($result == null and $usernameResult == null){
    $returnArray["status"] = "400";
    ...
    $returnArray["match"] = array();

    $returnArray["match"] = $usernameResult;
